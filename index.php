                ...
                <div class="container">
                    ...
                    <form action="search_result.php" method="GET" class="hero-form">
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="from_city" class="form-control" id="inputFromCity" list="cities"
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="to_city" class="form-control" id="inputToCity" list="cities"
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="datetime-local" name="date_from" class="form-control" id="dateTimeFrom"
                                required>
                        </div>

                        <div class="input-wrapper">
                            <label for="dateTimeTo" class="input-label">Date To</label>
                            <input type="datetime-local" name="date_to" class="form-control" id="dateTimeTo" required>
                        </div>
