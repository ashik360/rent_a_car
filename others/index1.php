...
<head>
  ...
  <?php include 'dependency_top.php' ?>
</head>
...
<body>
        ...
        <div class="container">
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="bannerImg-fix" src="assets/images/hero-banner.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img class="bannerImg-fix" src="assets/images/car-2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img class="bannerImg-fix" src="assets/images/car-5.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                  <img class="bannerImg-fix" src="assets/images/car-6.jpg" class="d-block w-100" alt="...">
                </div>
              </div>
          ...
          <form action="" class="hero-form">
            <div class="input-wrapper">
              ...
              <input type="text" name="from" class="form-control" id="inputFromCity" list="cities" placeholder="Dhaka"
                required>
              <datalist id="cities">
                <option value="Dhaka">
            ...
            <div class="input-wrapper">
              ...
              <input type="text" name="from" class="form-control" id="inputFromCity" list="cities" placeholder="Gazipur"
                required>
              <datalist id="cities">
                <option value="Dhaka">
                <option value="Chattogram">
            ...
            <div class="input-wrapper">
              ...
              <input type="text" name="from" class="form-control" id="inputFromCity" list="time-days" placeholder="10"
                required>
                  ...
                  <div class="featured-car-card">
                    ...
                    <div style="align-items: normal" class="card-content">
                      ...
                      <div class="card-price-wrapper">
                        <p class="card-price"><strong>9000 <i class="fa-solid fa-bangladeshi-taka-sign"></i></strong>/ Hour
                        </p>
  ...
  <?php include 'dependency_bottom.php'?>
</body>
